                    ...
                    <div class="border-b border-gray-200">
                        <div class="-mb-px flex px-4 space-x-8" aria-orientation="horizontal" role="tablist">
                            ...
                            <button id="tabs-1-tab-1"
                                ...
                                aria-controls="tabs-1-panel-1" role="tab" type="button" x-on:click="tabSelected=1" >Women</button>

                            <!-- Selected: "text-indigo-600 border-indigo-600", Not Selected: "text-gray-900 border-transparent" -->
                            <button id="tabs-1-tab-2"
                                class="text-gray-900 border-transparent flex-1 whitespace-nowrap py-4 px-1 border-b-2 text-base font-medium"
                                aria-controls="tabs-1-panel-2" role="tab" type="button"  x-on:click="tabSelected=2" >Men</button>
                        </div>
                    </div>
            ...
            <div class="border-b border-gray-200">
                <div class="h-16 flex items-center">
                            ...
                            <div class="flex">
                                <div class="relative flex">
                                    ...
                                    <button type="button"
                                        ...
                                        aria-expanded="false"  x-on:click="tabSelected==1? tabSelected=0 : tabSelected=1 ">Women</button>
                                </div>
                    ...
                    Leaving: "transition ease-in duration-150"
                      ...
                      To: "opacity-0"
                  -->
                                <div class="absolute top-full inset-x-0 text-sm text-gray-500 z-20" x-show="tabSelected==1" >
                                                ...
                                                <div class="row-start-1 grid grid-cols-3 gap-y-10 gap-x-8 text-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul role="list" aria-labelledby="Accessories-heading"
                                                            ...
                                                            <li class="flex">
                                                                <a href="#" class="hover:text-gray-800"> Belts
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul role="list" aria-labelledby="Brands-heading"
                                                            ...
                                                            <li class="flex">
                                                                <a href="#" class="hover:text-gray-800"> My Way
                                                                </a>
                                                            </li>
                    ...
                    Leaving: "transition ease-in duration-150"
                      ...
                      To: "opacity-0"
                  -->
                                <div class="absolute top-full inset-x-0 text-sm text-gray-500 z-10" x-show="tabSelected==2" >
                                    <!-- Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow -->
                                    <div class="absolute inset-0 top-1/2 bg-white shadow" aria-hidden="true"></div>
